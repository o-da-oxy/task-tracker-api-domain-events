...
public class Project : Aggregate<ProjectId>
{
    ...
    public static Project Create(ProjectId id, string name, bool isDeleted = false)
    {
        ...
        Console.WriteLine("ДОСТАТЬ ВСЕ СОБЫТИЯ Project Create");
        Console.WriteLine(project.GetDomainEvents()[0]);
    ...
    public void AddCommand(Command command)
    {
        ...
        // var @event = new CommandAddedToProjectDomainEvent(Id.Value, command.Id.Value);
    ...
    {
        Sprints.Add(sprint);
        // var @event = new SprintAddedToProjectDomainEvent(Id.Value, sprint.Id.Value);
        // AddDomainEvent(@event);
    }
    ...
    public void AddDeveloper(Developer developer)
    {
        ...
        // var @event = new DeveloperAddedToProjectDomainEvent(Id.Value, developer.Id.Value);
        // AddDomainEvent(@event);
    }
}
